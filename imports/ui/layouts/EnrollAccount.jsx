    ...
    return (
      <div>
        ...
        <form onSubmit={this.handleSubmit.bind(this)}>
          ...
          <div><input type="text" placeholder="Confirm password"></input></div>
          <div><input type="text" placeholder="Country"></input></div>
          <div><input type="text" placeholder="Zip Code"></input></div>
          <div className="form-group col-md-offset-4 col-md-4">
